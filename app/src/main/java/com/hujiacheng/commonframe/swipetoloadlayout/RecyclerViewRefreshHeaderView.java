 ...
 */
public class RecyclerViewRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    public RecyclerViewRefreshHeaderView(Context context) {
        this(context, null);
    }

    public RecyclerViewRefreshHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
