package com.hujiacheng.custom.dragbubble;
...
import com.hujiacheng.custom.dragbubble.widget.DragBubbleView;

import java.util.ArrayList;
import java.util.Random;


public class DragBubbleActivity extends Activity implements OnTouchListener, OnClickListener {
    ...
    private class MessageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(getApplication()).inflate(R.layout.item_dragbubblelist, parent, false);
            }
            // 简易demo, ViewHolder略
            ...
            if (message.unreadNum > 0) {
                ...
                number.setOnTouchListener(DragBubbleActivity.this);
                number.setOnClickListener(DragBubbleActivity.this);
            } else {
